import { FeatureKind, Features, FeatureType, } from '../../../core/features';
// upgrade features from lower version to higher version
export async function upsertFeature(db, feature) {
    const hasEqualOrGreaterVersion = (await db.features.count({
        where: {
...
export async function migrateNewFeatureTable(prisma) {
